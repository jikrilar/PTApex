                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('upload.excel') }}" class="btn btn-success ml-3">Import Candidate <i
                                    class="fa fa-plus"></i></a>
                                ...
                                <tbody>
                                    @foreach ($employees as $employee)
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="savings/create/{{ $employee->id }}"
                                                    class="btn btn-warning">Simpan</a>
                                                <a href="loan/create/{{ $employee->id }}"
